 ...
 */
function setCapturePolicyMode(vault, field, mode) {
 ...
 */
function archiveOldEpisodes(vault, maxDays = 90) {
...
function parseMemoryFrontmatter(text) {
  ...
  return { meta, hook: HOOK_FRONTMATTER.parseHookFrontmatter(match[1]) };
}
