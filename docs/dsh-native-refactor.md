...
状态：**已实现（0.7.1）**。本文档记录设计规格、迁移过程与最终结论。§2 有对「仅 `dsh plugin` 即可完整安装」这条原始假设的修正（in-box bundle 不能 pnpm 拉，能力走 bundle + 姿态由安装程序写骨架）。
...
- [ ] `docs/handoff.md`、`docs/changelog.md`、根 `CHANGELOG.md`。
