...
> 最后更新：2026-08 大改收尾——仓库文档大改 + 文献库子系统 + 记忆系统强化（两轮）+ Phase 1 解耦 + Phase 2a/2b dsh web 面板 + 面板方案 A（两实例）。**版本 0.6.1（2026-08-23）**。
...
- 版本 0.6.1（2026-08-23：链接站内跳转 + 数学交流提示词 + ask_user 节制）。
